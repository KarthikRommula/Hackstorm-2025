...
const HackathonWebsite = () => {
      ...
      content: (
        <div className="space-y-4">
          {[
            ...
            <div key={index} className="bg-white/10 backdrop-blur-lg p-4 rounded-lg">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <nav className="fixed w-full z-50 bg-gray-900/80 backdrop-blur-lg border-b border-white/10">
          ...
          <div className="md:hidden bg-gray-900/95 backdrop-blur-lg border-t border-white/10">
            {Object.entries(tabs).map(([key, value]) => (
              <button
                ...
                className="block w-full text-left px-4 py-3 text-gray-300 hover:text-white hover:bg-white/10"
              >
                <div className="flex items-center space-x-2">
                  {value.icon}
                  <span>{value.title}</span>
        ...
        <section className="min-h-screen flex flex-col items-center justify-center px-4 pt-16">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <button className="px-8 py-4 rounded-lg border border-white/20 hover:bg-white/10 backdrop-blur-lg transition-all">
                Learn More
              </button>
            </div>
          </div>
      ...
      <footer className="relative z-10 bg-gray-900/80 backdrop-blur-lg border-t border-white/10 py-8">
